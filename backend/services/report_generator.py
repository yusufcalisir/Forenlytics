...
FORENSIC_DISCLAIMER = (
    ...
    "& Splicing 3-class benchmark, N=120 samples, Composite EER=20.0%, AUC=0.881, Splice Localization Recall=100.0%). These findings do not "
        ...
        try:
            ...
            if has_compare:
                obs_parts.append(
                    ...
                    f"speaker embeddings (30%), vocal tract LPC formant resonances (25%), pitch F0 intonation dynamics (25%), "
                    f"13-band spectral MFCC fingerprints (15%), speaking rhythm (3%), and energy dynamics (2%)."
                )
                if disagreements:
                    obs_parts.append(
